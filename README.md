...
| Main-executable function inventory | 2,507 total: 1,487 verified, 102 manually reviewed, 167 library signatures, 751 unverified |
...
| Exact reconstruction | 1,557 functions / 196,580 selected bytes: 1,487/187,208 main executable plus 70/9,372 HOW TO PLAY overlay |
| PsyQ coverage | 60 BIOS/kernel trampolines and 34 real GTE/COP2 functions |
| Game-owned modules | `mode-control`: 20/1,660; `runtime-core`: 6/2,232; `screen-selector`: 22/2,348; session router/opening/gameplay/endgame: 51/8,736; `state-transition`: 117/16,132; `runtime-graphics-init`: 8/1,020; `graphics-primitive-builder`: 4/988 |
...
Exact accepted reconstruction currently covers 1,487 of 2,507 main-executable
functions (about 59.3%; 187,208 of 1,050,624 code-region bytes, about 17.8%),
plus all

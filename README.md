...
| Main-executable function inventory | 2,424 total: 1,185 verified, 102 manually reviewed, 257 library signatures, 880 unverified |
...
| Exact reconstruction | 1,255 functions / 138,192 selected bytes: 1,185/128,820 main executable plus 70/9,372 HOW TO PLAY overlay |
...
Exact accepted reconstruction currently covers 1,185 of 2,424 main-executable
functions (about 48.9%; 128,820 of 1,050,624 code-region bytes, about 12.3%),
plus all
...
- Library-signature reconstruction batches 1-10 (1,020 functions total)
  closed every named main-executable signature from 8 to 255 bytes, plus
  every gap-sweep-discovered `tool_heuristic` function of any size. 257
  named signatures remain: 90 at 256+ bytes and 167 anomalous 1-/4-byte
  entries excluded from every batch so far.

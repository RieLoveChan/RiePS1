...
| Main-executable function inventory | 2,593 total: 1,578 verified, 102 manually reviewed, 167 library signatures, 659 unverified |
...
| Exact reconstruction | 1,648 functions / 266,592 selected bytes: 1,578/257,924 main executable plus 70/9,372 HOW TO PLAY overlay |
...
| Latest game-owned module | `runtime-helper-8ebac`: 1/380 |

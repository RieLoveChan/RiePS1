...
| Main-executable function inventory | 2,580 total: 1,565 verified, 102 manually reviewed, 167 library signatures, 672 unverified |
...
| Exact reconstruction | 1,635 functions / 249,192 selected bytes: 1,565/240,524 main executable plus 70/9,372 HOW TO PLAY overlay |
...
| Latest game-owned module | `runtime-helper-89da4`: 1/2,856 |

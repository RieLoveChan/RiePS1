...
| Main-executable function inventory | 2,614 total: 1,599 verified, 102 manually reviewed, 167 library signatures, 638 unverified |
...
| Exact reconstruction | 1,669 functions / 285,964 selected bytes: 1,599/276,776 main executable plus 70/9,372 HOW TO PLAY overlay |
...
| Latest game-owned module | `runtime-helper-93ae8`: 1/488 |

...
| Main-executable function inventory | 2,597 total: 1,582 verified, 102 manually reviewed, 167 library signatures, 655 unverified |
...
| Exact reconstruction | 1,652 functions / 271,660 selected bytes: 1,582/262,992 main executable plus 70/9,372 HOW TO PLAY overlay |
...
| Latest game-owned module | `runtime-helper-8ff00`: 1/500 |

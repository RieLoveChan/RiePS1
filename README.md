...
| Main-executable function inventory | 2,584 total: 1,569 verified, 102 manually reviewed, 167 library signatures, 668 unverified |
...
| Exact reconstruction | 1,639 functions / 251,404 selected bytes: 1,569/242,736 main executable plus 70/9,372 HOW TO PLAY overlay |
...
| Latest game-owned module | `runtime-helper-8ae04`: 1/876 |

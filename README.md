...
| Main-executable function inventory | 2,621 total: 1,606 verified, 102 manually reviewed, 167 library signatures, 631 unverified |
...
| Exact reconstruction | 1,676 functions / 294,692 selected bytes: 1,606/285,504 main executable plus 70/9,372 HOW TO PLAY overlay |
...
| Latest game-owned module | `runtime-helper-95ebc`: 1/324 |

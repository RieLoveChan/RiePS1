...
| Main-executable function inventory | 2,623 total: 1,608 verified, 102 manually reviewed, 167 library signatures, 629 unverified |
...
| Exact reconstruction | 1,678 functions / 295,276 selected bytes: 1,608/286,088 main executable plus 70/9,372 HOW TO PLAY overlay |
...
| Latest game-owned module | `runtime-helper-96558`: 1/200 |

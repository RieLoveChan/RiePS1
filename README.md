...
| Main-executable function inventory | 2,585 total: 1,570 verified, 102 manually reviewed, 167 library signatures, 667 unverified |
...
| Exact reconstruction | 1,640 functions / 255,688 selected bytes: 1,570/247,020 main executable plus 70/9,372 HOW TO PLAY overlay |
...
| Latest game-owned module | `runtime-helper-8b170`: 1/4,284 |

...
| Main-executable function inventory | 2,588 total: 1,573 verified, 102 manually reviewed, 167 library signatures, 664 unverified |
...
| Exact reconstruction | 1,643 functions / 257,536 selected bytes: 1,573/248,868 main executable plus 70/9,372 HOW TO PLAY overlay |
...
| Latest game-owned module | `runtime-helper-8c7b4`: 1/432 |

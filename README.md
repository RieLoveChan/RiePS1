...
| Main-executable function inventory | 2,581 total: 1,566 verified, 102 manually reviewed, 167 library signatures, 671 unverified |
...
| Exact reconstruction | 1,636 functions / 249,460 selected bytes: 1,566/240,792 main executable plus 70/9,372 HOW TO PLAY overlay |
...
| Latest game-owned module | `runtime-helper-8a8cc`: 1/268 |

...
| Main-executable function inventory | 2,595 total: 1,580 verified, 102 manually reviewed, 167 library signatures, 657 unverified |
...
| Exact reconstruction | 1,650 functions / 268,676 selected bytes: 1,580/260,008 main executable plus 70/9,372 HOW TO PLAY overlay |
...
| Latest game-owned module | `runtime-helper-8f254`: 1/760 |

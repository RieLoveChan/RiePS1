...
| Main-executable function inventory | 2,617 total: 1,602 verified, 102 manually reviewed, 167 library signatures, 635 unverified |
...
| Exact reconstruction | 1,672 functions / 288,348 selected bytes: 1,602/279,160 main executable plus 70/9,372 HOW TO PLAY overlay |
...
| Latest game-owned module | `runtime-helper-93f20`: 1/1,792 |

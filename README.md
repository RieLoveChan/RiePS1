...
| Main-executable function inventory | 2,619 total: 1,604 verified, 102 manually reviewed, 167 library signatures, 633 unverified |
...
| Exact reconstruction | 1,674 functions / 293,916 selected bytes: 1,604/284,728 main executable plus 70/9,372 HOW TO PLAY overlay |
...
| Latest game-owned module | `runtime-helper-95590`: 1/1,616 |

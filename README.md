...
| Main-executable function inventory | 2,596 total: 1,581 verified, 102 manually reviewed, 167 library signatures, 656 unverified |
...
| Exact reconstruction | 1,651 functions / 271,160 selected bytes: 1,581/262,492 main executable plus 70/9,372 HOW TO PLAY overlay |
...
| Latest game-owned module | `runtime-helper-8f54c`: 1/2,484 |

...
| HOW TO PLAY overlay | Full 11,864-byte structural map; 70 functions/9,372 code bytes plus 9 semantic data sections/2,228 bytes exact (11,600 selected bytes, 97.8%); all 748 tail bytes structurally resolved; 1,910-tick script verified |

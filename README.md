...
| Main-executable function inventory | 2,622 total: 1,607 verified, 102 manually reviewed, 167 library signatures, 630 unverified |
...
| Exact reconstruction | 1,677 functions / 295,076 selected bytes: 1,607/285,888 main executable plus 70/9,372 HOW TO PLAY overlay |
...
| Latest game-owned module | `runtime-helper-96000`: 1/384 |

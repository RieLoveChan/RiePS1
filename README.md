...
| Main-executable function inventory | 2,601 total: 1,586 verified, 102 manually reviewed, 167 library signatures, 651 unverified |
...
| Exact reconstruction | 1,656 functions / 277,980 selected bytes: 1,586/268,792 main executable plus 70/9,372 HOW TO PLAY overlay |
...
| Latest game-owned module | `runtime-helper-90f74`: 1/2,672 |

...
| Main-executable function inventory | 2,530 total: 1,515 verified, 102 manually reviewed, 167 library signatures, 722 unverified |
...
| Exact reconstruction | 1,585 functions / 207,268 selected bytes: 1,515/197,896 main executable plus 70/9,372 HOW TO PLAY overlay |
...
Exact accepted reconstruction currently covers 1,515 of 2,530 main-executable
functions (about 59.9%; 197,896 of 1,050,624 code-region bytes, about 18.8%),
plus all

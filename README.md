...
| Main-executable function inventory | 2,599 total: 1,584 verified, 102 manually reviewed, 167 library signatures, 653 unverified |
...
| Exact reconstruction | 1,654 functions / 273,496 selected bytes: 1,584/264,828 main executable plus 70/9,372 HOW TO PLAY overlay |
...
| Latest game-owned module | `runtime-helper-902cc`: 1/1,364 |

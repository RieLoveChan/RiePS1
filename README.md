...
| Main-executable function inventory | 2,592 total: 1,577 verified, 102 manually reviewed, 167 library signatures, 660 unverified |
...
| Exact reconstruction | 1,647 functions / 266,212 selected bytes: 1,577/257,544 main executable plus 70/9,372 HOW TO PLAY overlay |
...
| Latest game-owned module | `runtime-helper-8e7bc`: 1/908 |

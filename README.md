...
| Main-executable function inventory | 2,608 total: 1,593 verified, 102 manually reviewed, 167 library signatures, 644 unverified |
...
| Exact reconstruction | 1,663 functions / 282,100 selected bytes: 1,593/272,912 main executable plus 70/9,372 HOW TO PLAY overlay |
...
| Latest game-owned module | `runtime-helper-92968`: 1/280 |

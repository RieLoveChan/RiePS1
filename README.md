...
| Main-executable function inventory | 2,620 total: 1,605 verified, 102 manually reviewed, 167 library signatures, 632 unverified |
...
| Exact reconstruction | 1,675 functions / 294,368 selected bytes: 1,605/285,180 main executable plus 70/9,372 HOW TO PLAY overlay |
...
| Latest game-owned module | `runtime-helper-95cf8`: 1/452 |

...
| Main-executable function inventory | 2,583 total: 1,568 verified, 102 manually reviewed, 167 library signatures, 669 unverified |
...
| Exact reconstruction | 1,638 functions / 250,528 selected bytes: 1,568/241,860 main executable plus 70/9,372 HOW TO PLAY overlay |
...
| Latest game-owned module | `runtime-helper-8ac3c`: 1/456 |

...
| Main-executable function inventory | 2,610 total: 1,595 verified, 102 manually reviewed, 167 library signatures, 642 unverified |
...
| Exact reconstruction | 1,665 functions / 282,852 selected bytes: 1,595/273,664 main executable plus 70/9,372 HOW TO PLAY overlay |
...
| Latest game-owned module | `runtime-helper-92ca8`: 1/200 |

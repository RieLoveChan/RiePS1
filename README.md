...
| Main-executable function inventory | 2,602 total: 1,587 verified, 102 manually reviewed, 167 library signatures, 650 unverified |
...
| Exact reconstruction | 1,657 functions / 278,428 selected bytes: 1,587/269,240 main executable plus 70/9,372 HOW TO PLAY overlay |
...
| Latest game-owned module | `runtime-helper-919e4`: 1/448 |

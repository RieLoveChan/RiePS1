...
| Main-executable function inventory | 2,572 total: 1,557 verified, 102 manually reviewed, 167 library signatures, 680 unverified |
...
| Exact reconstruction | 1,627 functions / 240,592 selected bytes: 1,557/231,220 main executable plus 70/9,372 HOW TO PLAY overlay |
...
Exact accepted reconstruction currently covers 1,557 of 2,572 main-executable
functions (about 60.6%; 231,220 of 1,050,624 code-region bytes, about 22.0%),
plus all

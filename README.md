...
| Main-executable function inventory | 2,607 total: 1,592 verified, 102 manually reviewed, 167 library signatures, 645 unverified |
...
| Exact reconstruction | 1,662 functions / 281,820 selected bytes: 1,592/272,632 main executable plus 70/9,372 HOW TO PLAY overlay |
...
| Latest game-owned module | `runtime-helper-92854`: 1/276 |

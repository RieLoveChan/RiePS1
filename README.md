...
| Main-executable function inventory | 2,618 total: 1,603 verified, 102 manually reviewed, 167 library signatures, 634 unverified |
...
| Exact reconstruction | 1,673 functions / 292,300 selected bytes: 1,603/283,112 main executable plus 70/9,372 HOW TO PLAY overlay |
...
| Latest game-owned module | `runtime-helper-94620`: 1/3,952 |

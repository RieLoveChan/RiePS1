...
| Main-executable function inventory | 2,606 total: 1,591 verified, 102 manually reviewed, 167 library signatures, 646 unverified |
...
| Exact reconstruction | 1,661 functions / 281,544 selected bytes: 1,591/272,356 main executable plus 70/9,372 HOW TO PLAY overlay |
...
| Latest game-owned module | `runtime-helper-92754`: 1/256 |

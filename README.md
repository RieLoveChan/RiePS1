...
| Main-executable function inventory | 2,564 total: 1,549 verified, 102 manually reviewed, 167 library signatures, 688 unverified |
...
| Exact reconstruction | 1,619 functions / 233,428 selected bytes: 1,549/224,056 main executable plus 70/9,372 HOW TO PLAY overlay |
...
Exact accepted reconstruction currently covers 1,549 of 2,564 main-executable
functions (about 60.4%; 224,056 of 1,050,624 code-region bytes, about 21.3%),
plus all

...
| Main-executable function inventory | 2,605 total: 1,590 verified, 102 manually reviewed, 167 library signatures, 647 unverified |
...
| Exact reconstruction | 1,660 functions / 281,288 selected bytes: 1,590/272,100 main executable plus 70/9,372 HOW TO PLAY overlay |
...
| Latest game-owned module | `runtime-helper-92538`: 1/540 |

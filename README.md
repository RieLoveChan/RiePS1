...
| Main-executable function inventory | 2,604 total: 1,589 verified, 102 manually reviewed, 167 library signatures, 648 unverified |
...
| Exact reconstruction | 1,659 functions / 280,748 selected bytes: 1,589/271,560 main executable plus 70/9,372 HOW TO PLAY overlay |
...
| Latest game-owned module | `runtime-helper-91e20`: 1/1,684 |

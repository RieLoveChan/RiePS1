...
| Main-executable function inventory | 2,624 total: 1,609 verified, 102 manually reviewed, 167 library signatures, 628 unverified |
...
| Exact reconstruction | 1,679 functions / 295,916 selected bytes: 1,609/286,728 main executable plus 70/9,372 HOW TO PLAY overlay |
...
| Latest game-owned module | `runtime-helper-966f8`: 1/640 |

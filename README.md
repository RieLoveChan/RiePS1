...
| Main-executable function inventory | 2,615 total: 1,600 verified, 102 manually reviewed, 167 library signatures, 637 unverified |
...
| Exact reconstruction | 1,670 functions / 286,336 selected bytes: 1,600/277,148 main executable plus 70/9,372 HOW TO PLAY overlay |
...
| Latest game-owned module | `runtime-helper-93cd0`: 1/372 |

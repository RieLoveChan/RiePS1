...
| Main-executable function inventory | 2,587 total: 1,572 verified, 102 manually reviewed, 167 library signatures, 665 unverified |
...
| Exact reconstruction | 1,642 functions / 257,104 selected bytes: 1,572/248,436 main executable plus 70/9,372 HOW TO PLAY overlay |
...
| Latest game-owned module | `runtime-helper-8c538`: 1/636 |

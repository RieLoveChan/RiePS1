...
| Main-executable function inventory | 2,603 total: 1,588 verified, 102 manually reviewed, 167 library signatures, 649 unverified |
...
| Exact reconstruction | 1,658 functions / 279,064 selected bytes: 1,588/269,876 main executable plus 70/9,372 HOW TO PLAY overlay |
...
| Latest game-owned module | `runtime-helper-91ba4`: 1/636 |

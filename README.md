...
| Main-executable function inventory | 2,594 total: 1,579 verified, 102 manually reviewed, 167 library signatures, 658 unverified |
...
| Exact reconstruction | 1,649 functions / 267,916 selected bytes: 1,579/259,248 main executable plus 70/9,372 HOW TO PLAY overlay |
...
| Latest game-owned module | `runtime-helper-8ed28`: 1/1,324 |

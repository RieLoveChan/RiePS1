...
| Main-executable function inventory | 2,591 total: 1,576 verified, 102 manually reviewed, 167 library signatures, 661 unverified |
...
| Exact reconstruction | 1,646 functions / 265,304 selected bytes: 1,576/256,636 main executable plus 70/9,372 HOW TO PLAY overlay |
...
| Latest game-owned module | `runtime-helper-8cd3c`: 1/6,784 |

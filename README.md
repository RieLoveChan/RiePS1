...
| Main-executable function inventory | 2,589 total: 1,574 verified, 102 manually reviewed, 167 library signatures, 663 unverified |
...
| Exact reconstruction | 1,644 functions / 257,948 selected bytes: 1,574/249,280 main executable plus 70/9,372 HOW TO PLAY overlay |
...
| Latest game-owned module | `runtime-helper-8c964`: 1/412 |

...
| Main-executable function inventory | 2,586 total: 1,571 verified, 102 manually reviewed, 167 library signatures, 666 unverified |
...
| Exact reconstruction | 1,641 functions / 256,468 selected bytes: 1,571/247,800 main executable plus 70/9,372 HOW TO PLAY overlay |
...
| Latest game-owned module | `runtime-helper-8c22c`: 1/780 |

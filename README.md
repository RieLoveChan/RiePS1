...
| Main-executable function inventory | 2,582 total: 1,567 verified, 102 manually reviewed, 167 library signatures, 670 unverified |
...
| Exact reconstruction | 1,637 functions / 250,072 selected bytes: 1,567/241,404 main executable plus 70/9,372 HOW TO PLAY overlay |
...
| Latest game-owned module | `runtime-helper-8a9d8`: 1/612 |

...
| Main-executable function inventory | 2,600 total: 1,585 verified, 102 manually reviewed, 167 library signatures, 652 unverified |
...
| Exact reconstruction | 1,655 functions / 275,308 selected bytes: 1,585/266,120 main executable plus 70/9,372 HOW TO PLAY overlay |
...
| Latest game-owned module | `runtime-helper-90860`: 1/1,812 |

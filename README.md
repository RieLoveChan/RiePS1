...
| Main-executable function inventory | 2,590 total: 1,575 verified, 102 manually reviewed, 167 library signatures, 662 unverified |
...
| Exact reconstruction | 1,645 functions / 258,520 selected bytes: 1,575/249,852 main executable plus 70/9,372 HOW TO PLAY overlay |
...
| Latest game-owned module | `runtime-helper-8cb00`: 1/572 |

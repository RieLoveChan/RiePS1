...
| Main-executable function inventory | 2,598 total: 1,583 verified, 102 manually reviewed, 167 library signatures, 654 unverified |
...
| Exact reconstruction | 1,653 functions / 272,132 selected bytes: 1,583/263,464 main executable plus 70/9,372 HOW TO PLAY overlay |
...
| Latest game-owned module | `runtime-helper-900f4`: 1/472 |

...
DDR_STATIC_ASSERT(ddr_display_width_offset, __builtin_offsetof(DdrModeState, display_width) == 0x0c);
DDR_STATIC_ASSERT(ddr_display_height_offset, __builtin_offsetof(DdrModeState, display_height) == 0x0e);
DDR_STATIC_ASSERT(ddr_display_mode_offset, __builtin_offsetof(DdrModeState, display_mode) == 0x10);
DDR_STATIC_ASSERT(ddr_display_dither_offset, __builtin_offsetof(DdrModeState, display_dither) == 0x12);

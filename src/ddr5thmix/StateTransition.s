...
.section .text.FUN_80029850,"ax",@progbits
.globl FUN_80029850
.type FUN_80029850, @function
.ent FUN_80029850
FUN_80029850:
    andi    $a0,$a0,0xff
    sll     $a0,$a0,0x3
    ...
    addu    $v0,$a0,$v0
.end FUN_80029850
.size FUN_80029850, . - FUN_80029850
.section .text.FUN_80029868,"ax",@progbits
.globl FUN_80029868
.type FUN_80029868, @function
.ent FUN_80029868
FUN_80029868:
    addiu   $sp,$sp,-32
    sw      $s0,16($sp)
...
.L800298e8:
    ...
    addiu   $sp,$sp,32
.end FUN_80029868
.size FUN_80029868, . - FUN_80029868
.section .text.FUN_80029920,"ax",@progbits
.globl FUN_80029920
.type FUN_80029920, @function
.ent FUN_80029920
FUN_80029920:
    addiu   $sp,$sp,-40
    sw      $s1,28($sp)
...
.L80029948:
    ...
    addiu   $a2,$sp,18
    andi    $v0,$v0,0xff
    bne     $v0,$zero,.L800299c8
    addiu   $v0,$zero,-1
    lhu     $a0,16($sp)
    sll     $zero,$zero,0
    slti    $v0,$a0,3
    beq     $v0,$zero,.L80029980
    sll     $zero,$zero,0
    bgez    $a0,.L80029988
    lui     $v1,0x800e
.L80029980:
...
.L800299c8:
    ...
    addiu   $sp,$sp,40
.end FUN_80029920
.size FUN_80029920, . - FUN_80029920
.section .text.FUN_800299dc,"ax",@progbits
.globl FUN_800299dc
.type FUN_800299dc, @function
.ent FUN_800299dc
FUN_800299dc:
    addiu   $sp,$sp,-32
    sw      $s0,16($sp)
...
.L80029a24:
    ...
    addiu   $sp,$sp,32
.end FUN_800299dc
.size FUN_800299dc, . - FUN_800299dc
.section .text.FUN_80029a4c,"ax",@progbits
.globl FUN_80029a4c
.type FUN_80029a4c, @function
.ent FUN_80029a4c
FUN_80029a4c:
    addiu   $sp,$sp,-32
    sw      $s0,16($sp)
...
.section .text.FUN_80029c40,"ax",@progbits
.globl FUN_80029c40
.type FUN_80029c40, @function
.ent FUN_80029c40
FUN_80029c40:
    addiu   $sp,$sp,-32
    sw      $s0,24($sp)
...
.section .text.FUN_80029cdc,"ax",@progbits
.globl FUN_80029cdc
.type FUN_80029cdc, @function
.ent FUN_80029cdc
FUN_80029cdc:
    addiu   $sp,$sp,-24
    andi    $v0,$a0,0xffff
    sltiu   $v0,$v0,31
    bne     $v0,$zero,.L80029cf4
    sw      $ra,16($sp)
    addiu   $a0,$zero,30
.L80029cf4:
    lui     $v0,0x8002
...
.section .text.FUN_80029da0,"ax",@progbits
.globl FUN_80029da0
.type FUN_80029da0, @function
.ent FUN_80029da0
FUN_80029da0:
    addiu   $sp,$sp,-32
    lui     $v0,0x800e
...
.section .text.FUN_80029ef8,"ax",@progbits
.globl FUN_80029ef8
.type FUN_80029ef8, @function
.ent FUN_80029ef8
FUN_80029ef8:
    addiu   $sp,$sp,-24
    sw      $s0,16($sp)
    ...
    addiu   $sp,$sp,24
.end FUN_80029ef8
.size FUN_80029ef8, . - FUN_80029ef8
.section .text.FUN_80029f40,"ax",@progbits
.globl FUN_80029f40
.type FUN_80029f40, @function
.ent FUN_80029f40
FUN_80029f40:
    addu    $t1,$zero,$zero
    lui     $v0,0x800e
...
.L80029fd4:
    ...
    andi    $v0,$a3,0xffff
    sltu    $v0,$v0,$t0
    bne     $v0,$zero,.L80029fa8
    andi    $v0,$a3,0xffff
.L80029fe8:
    addiu   $t1,$t1,1
    andi    $v0,$t1,0xffff
    sltiu   $v0,$v0,3
    bne     $v0,$zero,.L80029f60
    andi    $v1,$t1,0xffff
    jr      $ra
    addiu   $v0,$zero,-1
.end FUN_80029f40
.size FUN_80029f40, . - FUN_80029f40
.section .text.FUN_8002a004,"ax",@progbits
.globl FUN_8002a004
.type FUN_8002a004, @function
.ent FUN_8002a004
FUN_8002a004:
    addiu   $sp,$sp,-32
    sw      $s1,20($sp)
...
.L8002a020:
    ...
    addiu   $sp,$sp,32
.end FUN_8002a004
.size FUN_8002a004, . - FUN_8002a004
.section .text.FUN_8002a04c,"ax",@progbits
.globl FUN_8002a04c
.type FUN_8002a04c, @function
.ent FUN_8002a04c
FUN_8002a04c:
    addiu   $sp,$sp,-24
    sw      $ra,16($sp)
    ...
    addiu   $sp,$sp,24
.end FUN_8002a04c
.size FUN_8002a04c, . - FUN_8002a04c
.section .text.FUN_8002a0b8,"ax",@progbits
.globl FUN_8002a0b8
.type FUN_8002a0b8, @function
.ent FUN_8002a0b8
FUN_8002a0b8:
    lw      $t0,16($sp)
    andi    $a0,$a0,0xff
    sltiu   $v0,$a0,21
    beq     $v0,$zero,.L8002a0e8
    lui     $v1,0x800e
    addiu   $v1,$v1,14360
    sll     $v0,$a0,0x3
    addu    $v0,$v0,$v1
...
.section .text.FUN_8002a174,"ax",@progbits
.globl FUN_8002a174
.type FUN_8002a174, @function
.ent FUN_8002a174
FUN_8002a174:
    addiu   $sp,$sp,-24
    sw      $s0,16($sp)
    ...
    addiu   $sp,$sp,24
.end FUN_8002a174
.size FUN_8002a174, . - FUN_8002a174
.section .text.FUN_8002a1b0,"ax",@progbits
.globl FUN_8002a1b0
.type FUN_8002a1b0, @function
.ent FUN_8002a1b0
FUN_8002a1b0:
    addiu   $sp,$sp,-24
    sw      $s0,16($sp)
    ...
    addiu   $sp,$sp,24
.end FUN_8002a1b0
.size FUN_8002a1b0, . - FUN_8002a1b0
.section .text.FUN_8002a1f0,"ax",@progbits
.globl FUN_8002a1f0
.type FUN_8002a1f0, @function
.ent FUN_8002a1f0
FUN_8002a1f0:
    lui     $v1,0x800e
    addiu   $v0,$zero,272
...
.section .text.FUN_8002a20c,"ax",@progbits
.globl FUN_8002a20c
.type FUN_8002a20c, @function
.ent FUN_8002a20c
FUN_8002a20c:
    lui     $v0,0x800e
    lhu     $v1,14534($v0)
...
.section .text.FUN_8002a300,"ax",@progbits
.globl FUN_8002a300
.type FUN_8002a300, @function
.ent FUN_8002a300
FUN_8002a300:
    addiu   $sp,$sp,-40
    sw      $s0,16($sp)
...
.L8002a3a0:
    ...
    sll     $zero,$zero,0
    slti    $v0,$v0,16130
    bne     $v0,$zero,.L8002a3c8
    addiu   $v0,$zero,16129
    sw      $v0,0($s2)
.L8002a3c8:
    lw      $v0,0($s2)
    sll     $zero,$zero,0
    bne     $v0,$zero,.L8002a3dc
    addiu   $v0,$zero,1
    sw      $v0,0($s2)
.L8002a3dc:
    lw      $ra,36($sp)
    ...
    addiu   $sp,$sp,40
.end FUN_8002a300
.size FUN_8002a300, . - FUN_8002a300
.section .text.FUN_8002a3fc,"ax",@progbits
.globl FUN_8002a3fc
.type FUN_8002a3fc, @function
.ent FUN_8002a3fc
FUN_8002a3fc:
    addiu   $sp,$sp,-24
    sw      $ra,16($sp)
...
.section .text.FUN_8002a5a8,"ax",@progbits
.globl FUN_8002a5a8
.type FUN_8002a5a8, @function
.ent FUN_8002a5a8
FUN_8002a5a8:
    lui     $a2,0x204
    ori     $a2,$a2,0x811
...
.L8002a650:
    ...
    addiu   $sp,$sp,24
.end FUN_8002a5a8
.size FUN_8002a5a8, . - FUN_8002a5a8
.section .text.FUN_8002a670,"ax",@progbits
.globl FUN_8002a670
.type FUN_8002a670, @function
.ent FUN_8002a670
FUN_8002a670:
    lui     $v0,0x800e
    lw      $v0,11244($v0)
    ...
    sll     $zero,$zero,0
.end FUN_8002a670
.size FUN_8002a670, . - FUN_8002a670
.section .text.FUN_8002a680,"ax",@progbits
.globl FUN_8002a680
.type FUN_8002a680, @function
.ent FUN_8002a680
FUN_8002a680:
    lui     $v0,0x800e
    lui     $v1,0x800e
    ...
    sw      $v0,14176($v1)
.end FUN_8002a680
.size FUN_8002a680, . - FUN_8002a680
.section .text.FUN_8002a698,"ax",@progbits
.globl FUN_8002a698
.type FUN_8002a698, @function
.ent FUN_8002a698
FUN_8002a698:
    lui     $v0,0x800e
    lui     $v1,0x800e
    ...
    sw      $v0,14172($v1)
.end FUN_8002a698
.size FUN_8002a698, . - FUN_8002a698
.section .text.FUN_8002a6c8,"ax",@progbits
.globl FUN_8002a6c8
.type FUN_8002a6c8, @function
.ent FUN_8002a6c8
FUN_8002a6c8:
    lui     $v0,0x800e
    lw      $v1,14172($v0)
    ...
    srl     $v0,$a0,0xd
.end FUN_8002a6c8
.size FUN_8002a6c8, . - FUN_8002a6c8

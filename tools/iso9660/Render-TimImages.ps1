...
for($o=0;$o -le $b.Length-20;$o+=4){
 ...
 if(($f-band 8)-ne 0){$l=U32 $b $p;if($l-lt 12-or $p+$l-gt $b.Length){continue};$cw=U16 $b ($p+8);$ch=U16 $b ($p+10);if($cw-lt 1-or $ch-lt 1-or $l-ne(12+2*$cw*$ch)){continue};$clut=$p+12;$palettes=$ch;$p+=$l}

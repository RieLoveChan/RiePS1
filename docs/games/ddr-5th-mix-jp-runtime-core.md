...
Total: thirteen functions and 3,324 selected bytes.
...
After those harness corrections, all thirteen functions matched without changing
...
`FUN_80022208`, `FUN_80022570`, `FUN_800225e4`, and `FUN_80022604`, the same command
matched all 3,324 bytes against the same
executable SHA-256.
The aggregate report remains ignored under `/build/`.

This proves thirteen independently placed function bodies. It does not prove an

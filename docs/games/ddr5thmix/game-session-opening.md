...
[lifecycle router](/docs/games/ddr5thmix/game-session-router.md).
...
`FUN_800985c8`/`FUN_80098880` (see [globals](/docs/games/ddr5thmix/globals.md)'s
...
[screen-flow](/docs/games/ddr5thmix/screen-flow.md) state 0), which

...
| Latest game-owned module | `runtime-helper-98050`: 1/116 (a runtime record-header wrapper whose sole caller is `FUN_80097eb8`; it forwards record fields to the mode-gated propagator `FUN_800980c4` and returns a tagged mode word) |

...
* [DDR 5th Mix mode-control module](ddr-5th-mix-jp-mode-control.md) - First reproducible game-owned reconstruction unit: nine functions and shared state layouts.

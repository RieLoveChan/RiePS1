...
| `READ_DT.BIN` | 32,768,000 | `004cbd9fa5c260b32f25319f5ae652208a7c80fbb056fa0e72127eb83d30453a` | Mixed overlay/resource container; HOW TO PLAY overlay at `0x1630000`, six validated VAB banks (66 raw samples), 16 standalone VAG samples, 298 embedded TIM images plus 512 validated LZ-expanded TIM images (265 from 266 `0x80001094` descriptors, one a truncated duplicate; 247 packed in 20 `0x800010d4` streams), 28 validated `0x44` indexed containers split into 84 neutral sections, and one validated 22-object TMD at `0x1633068` |

---
type: Quirk Log
title: Cross-Game Vendor/Engine Quirks
description: Non-standard PS1 engineering practices confirmed across more than one game (or backed by an external citation), promoted from individual games' quirk logs.
tags: [ps1, quirks, konami, reverse-engineering]

...
* [Platform architecture](platform-architecture.md) - PS1 subsystems and binary-analysis knowledge required for reconstruction.
...
* [Global map schema](global-map-schema.md) - CSV columns and evidence rules for fixed-address data symbols and pointed-to layouts.
